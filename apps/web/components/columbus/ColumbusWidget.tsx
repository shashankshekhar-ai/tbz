      ...
      {!isOpen && (
        <div className="fixed bottom-6 right-6 z-50">
          <button
            ...
            className="flex items-center space-x-2.5 bg-white hover:bg-[#F7F8F9] text-[#0c2940] px-5 py-2.5 rounded-full shadow-2xl border border-[#D9E3E6] transition-all duration-300 hover:scale-105"
          >
            <span className="w-3 h-3 rounded-full bg-[#39918d] inline-block flex-shrink-0" />
            <span className="text-sm sm:text-base font-inter font-bold tracking-tight text-[#0c2940]">Columbus</span>
          </button>
        </div>
      )}
