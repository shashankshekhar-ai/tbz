...
export const AboutHero: React.FC<AboutHeroProps> = () => {
  return (
    ...
    >
      ...
      {/* Flowing Luminous Particles Background */}
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 my-auto">
        ...
        <div className="max-w-4xl space-y-6">
          ...
          >
            AI capability isn't built by checking boxes. It's built by creating the conditions where people can experiment, struggle, adapt, and gain confidence.
          </motion.p>
        </div>

        {/* Condition Cards Grid — Styled in the same tone as Head Background */}
        <motion.div
        ...
        >
          ...
          <div className="bg-[#0c2940] rounded-2xl p-6 sm:p-7 border border-[#3f6d67]/50 hover:border-[#39918d] transition-all duration-300 shadow-xl hover:shadow-2xl flex flex-col justify-between group backdrop-blur-sm">
            <div>
              ...
              <h2 className="t-h3 text-white mb-2 group-hover:text-[#39918d] transition-colors">
                Psychological Safety
              </h2>

              <p className="font-body text-sm sm:text-[15px] text-slate-300 leading-relaxed">
                Safe-to-fail environments where people can freely <strong className="text-white font-semibold">experiment</strong>, test prompt limits, and make mistakes without fear of judgment or compliance risk.
              </p>
            </div>
          ...
          <div className="bg-[#0c2940] rounded-2xl p-6 sm:p-7 border border-[#3f6d67]/50 hover:border-[#c57b4b] transition-all duration-300 shadow-xl hover:shadow-2xl flex flex-col justify-between group backdrop-blur-sm">
            <div>
              ...
              <h2 className="t-h3 text-white mb-2 group-hover:text-[#c57b4b] transition-colors">
                Learning Architecture
              </h2>

              <p className="font-body text-sm sm:text-[15px] text-slate-300 leading-relaxed">
                Structured multi-phase progression where teams <strong className="text-white font-semibold">struggle & adapt</strong> together through real workflows, converting initial friction into lasting fluency.
              </p>
            </div>
          ...
          <div className="bg-[#0c2940] rounded-2xl p-6 sm:p-7 border border-[#3f6d67]/50 hover:border-[#f8c51c] transition-all duration-300 shadow-xl hover:shadow-2xl flex flex-col justify-between group backdrop-blur-sm">
            <div>
              ...
              <h2 className="t-h3 text-white mb-2 group-hover:text-[#f8c51c] transition-colors">
                Workforce Readiness
              </h2>

              <p className="font-body text-sm sm:text-[15px] text-slate-300 leading-relaxed">
                Equipping people to <strong className="text-white font-semibold">gain confidence</strong> as autonomous builders who deploy, govern, and scale bespoke AI tools that drive measurable business impact.
              </p>
            </div>
