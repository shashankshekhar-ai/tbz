      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {placeholderCards.map((card) => (
            <div
              key={card.id}
              className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col justify-between min-h-[260px] relative overflow-hidden group hover:border-[#0f766e] transition-all duration-300 shadow-xs"
            >
              <div className="flex items-center justify-between">
                <span className="font-h2 text-[10px] font-bold uppercase tracking-widest text-[#0f766e] bg-teal-50 px-2.5 py-1 rounded border border-teal-200">
                  ADVISORY BOARD
                </span>
              ...
              <div className="w-full h-[1px] bg-slate-200 group-hover:bg-[#0f766e]/40 transition-colors" />
            </div>
          ))}
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-sm">
          <div className="space-y-1 text-center sm:text-left">
            <div className="flex items-center justify-center sm:justify-start gap-2 text-[#0f766e]">
