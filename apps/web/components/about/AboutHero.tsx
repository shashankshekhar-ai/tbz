...
export function AboutHero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-32 sm:pt-36 lg:pt-40 pb-16 sm:pb-20 lg:pb-24 px-6 sm:px-8 lg:px-12 bg-gradient-to-b from-[#0c2940] via-[#0c2940] to-[#082033] overflow-hidden border-b border-[#3f6d67]/30">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 my-auto">
        <div className="max-w-4xl space-y-6">
          ...
          <h1 className="font-h1 font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-[1.08] tracking-tight">
          ...
          <p className="font-body text-lg sm:text-xl lg:text-2xl text-slate-200 leading-relaxed max-w-3xl font-normal">
